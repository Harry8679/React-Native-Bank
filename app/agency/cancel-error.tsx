...
export default function CancelErrorScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white", padding: 20 }}>
      ...
      <Text style={{ fontSize: 24, color: "red", textAlign: "center", marginBottom: 30 }}>ACCUSÉ RÉCEPTION</Text>

      <Text style={{ textAlign: "center", marginBottom: 30 }}>
        ❌ L'annulation du code de retrait de: XXXXX FCFA {"\n"}
        Numéro: {code} {"\n"}
        a échoué. [Motif de l'échec]
      </Text>
